...
int GRASP(int max_iteration , int prob , double o)
{
    double alpha = 0.0 ;
...
int main()
{
   ...
   for(double o = 0.2 ; o<=0.8 ; o+=0.2)    
   {
       int max_cost = GRASP(max_iteration,j-1,o) ;
if(o!=0.2)	result<<" "<<","<<" "<<","<<" "<<"," ;
    cout<<max_cost<<endl ; 
   }
